        ...
        common.requestServerData("scores", "POST", {
            ...
            if (data.statusCode === 200) {
                ...
                self.setData({
                    ...
                    // averageScore: data.data.averages[0].average_score,
                    academicCredits: data.data.averages && data.data.averages[0] && data.data.averages[0].average_jidian ? data.data.averages[0].average_jidian : 0,
                    // alreadyCredits: data.data.averages[0].total_xuefen,
                    averageScore: maxLength == 0 ? 0 : (subScore / maxLength).toFixed(1),
                    // academicCredits: academicCredits.toFixed(1),
                    alreadyCredits: alreadyCredits || 0,
