        ...
        common.requestServerData("scores", "POST", {
            ...
            if (data.statusCode === 200) {
                ...
                endData.map((e) => {
                    ...
                    tit = (d1[0] - 0 + 2000) + '-' + (d1[1].split('(')[0] - 0 + 2000) + '第' + val + '学期'
                    e.name = tit
                })
                self.setData({
                    grede: endData,
                    ...
                    averageScore: data.data.averages[0].average_score || 0,
                    academicCredits: data.data.averages[0].average_jidian || 0,
                    alreadyCredits: data.data.averages[0].total_xuefen || 0,
