...
Page({
    ...
    data: {
        ...
        articleType: ['推荐阅读', '学校通知', '人物志', '吃喝玩乐'], // 资讯搜索
        articleList: [], // 资讯列表
        limit: 10, // 每页显示条数
        pages: 0, // 总页数
    ...
    openArticle: function() {
        wx.navigateTo({
            url: '/pages/webView/webView?title=校历&path=https://mp.weixin.qq.com/s/6OULIMOzvpHyGRO-MfDXbw'
        })
    },
